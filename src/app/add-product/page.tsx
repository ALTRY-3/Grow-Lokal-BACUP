...
export default function AddProductPage() {
  ...
  const validateForm = () => {
    ...
    if (productDesc.trim().length < 10)
      errors.push("Description must be at least 10 characters");
    if (productDesc.trim().length > 2000)
    ...
    <>
      ...
      <div className="add-product-wrapper" style={{ position: "relative" }}>
        ...
        <div className="add-product-card add-product-photo-card">
          <div className="add-product-photo-list">
            ...
            {existingImages.map((imageUrl, idx) => (
              <div
                className="add-product-photo-preview"
                key={`existing-${idx}`}
              >
                <img
                  src={imageUrl}
          ...
          <div className="add-product-photo-note">
            You can add up to 3 photos total.{" "}
        ...
        <div className="add-product-card">
          ...
          >
            {productName.length}/200 characters{" "}
        ...
        <div className="add-product-card">
          ...
          >
            {productDesc.length}/2000 characters{" "}
            {productDesc.length >= 10 && productDesc.length <= 2000 && "✓"}
          </span>
        </div>
        ...
        <div className="add-product-card add-product-fields-grid">
          <div className="add-product-field-row">
            ...
            <span
              style={{
                fontSize: "12px",
                color: parseFloat(price) > 0 ? "#4caf50" : "#e74c3c",
              }}
            >
          ...
          <div className="add-product-field-row">
            ...
            <span
              style={{
                fontSize: "12px",
                color: parseInt(stock) >= 0 ? "#4caf50" : "#e74c3c",
              }}
            >
